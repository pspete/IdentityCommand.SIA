...
Describe 'Invoke-SIAHttpsRelayCertificateRotation' {
    ...
    BeforeEach {
        ...
        $Script:response = Invoke-SIAHttpsRelayCertificateRotation -https_relay_id 'RELAY1'
    }
    ...
    Context 'Request' {
        ...
        It 'sends request to expected endpoint' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                $URI -eq 'https://somedomain.dpa.cyberark.cloud/api/https-relays/RELAY1/rotate'
