...
Describe 'Remove-SIASSHHostKeyFingerprint' {
    ...
    BeforeEach {
        ...
        $Script:response = Remove-SIASSHHostKeyFingerprint -target_id 'SomeTarget'
    }
    ...
    Context 'Request' {
        ...
        It 'sends request to expected endpoint' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                $URI -eq 'https://somedomain.dpa.cyberark.cloud/api/ssh-fingerprints/SomeTarget'
