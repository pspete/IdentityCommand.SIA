...
Describe 'Set-SIAConnectorMaintenanceMode' {
    ...
    BeforeEach {
        ...
        $Script:response = Set-SIAConnectorMaintenanceMode -connector_id '1234-abcd' -maintenance $true
    }
    ...
    Context 'Request' {
        ...
        It 'sends request to expected endpoint' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                $URI -eq 'https://somedomain.dpa.cyberark.cloud/api/connectors/1234-abcd/maintenance'
        ...
        It 'sends request with expected body' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                ($null -ne $Body) -and ($Body -match 'maintenance')
            } -Times 1 -Exactly -Scope It
        }
    }
