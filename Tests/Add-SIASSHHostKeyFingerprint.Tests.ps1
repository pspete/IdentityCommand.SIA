...
Describe 'Add-SIASSHHostKeyFingerprint' {
    ...
    BeforeEach {
        ...
        $Script:response = Add-SIASSHHostKeyFingerprint -target_id 'SomeTarget' -fingerprint 'SHA256:abc'
    }
    ...
    Context 'Request' {
        ...
        It 'sends request to expected endpoint' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                $URI -eq 'https://somedomain.dpa.cyberark.cloud/api/ssh-fingerprints'
        ...
        It 'sends request with expected body' {
            Should -Invoke -CommandName Invoke-IDRestMethod -ModuleName $Script:SIAModuleName -ParameterFilter {
                ($null -ne $Body) -and ($Body -match 'fingerprint')
            } -Times 1 -Exactly -Scope It
        }
    }
